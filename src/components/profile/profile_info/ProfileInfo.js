            ...
            <div className='col-sm-7'>
                <div className={s.user_description}>
                    <div className={s.user_container}>
                        ...
                        <div className={s.user_container}>
                            <div className={s.aboutMe}><span
                                className={s.user_contacts__header}>About me:</span>{props.profile.aboutMe}</div>
                            <div className={s.lookingForAJobDescription}><span className={s.user_contacts__header}>Looking for job:</span>{props.profile.lookingForAJobDescription}
                            </div>
                        </div>
                        {Object.keys(props.profile.contacts).some(item => props.profile.contacts[item] !== null) && <>
                            ...
                            <div className={s.user_container}>
                                ...
                                && <div className={s.facebook}><span
                                    className={s.user_contacts__header}>facebook:</span>{props.profile.contacts.facebook}
                                </div>}
                                {props.profile.contacts.website !== null
                                && <div className={s.website}><span
                                    className={s.user_contacts__header}>website:</span>{props.profile.contacts.website}
                                </div>}
                                ...
                                && <div className={s.twitter}><span
                                    className={s.user_contacts__header}>twitter:</span>{props.profile.contacts.twitter}
                                </div>}
                                ...
                                && <div className={s.youtube}><span
                                    className={s.user_contacts__header}>youtube:</span>{props.profile.contacts.youtube}
                                </div>}
                                {props.profile.contacts.github !== null
                                && <div className={s.github}><span
                                    className={s.user_contacts__header}>github:</span>{props.profile.contacts.github}
                                </div>}
                                {props.profile.contacts.mainLink !== null
                                && <div className={s.mainLink}><span
                                    className={s.user_contacts__header}>mainLink:</span>{props.profile.contacts.mainLink}
                                </div>}
                            </div>
                        </>}
                </div>
